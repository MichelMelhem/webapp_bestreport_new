          ...
          >
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-800">
                Streamlined Site Supervision
              </h3>
              <p className="text-gray-600">
                Monitor all aspects of your construction site with our intuitive
                supervision tools. Track worker attendance, equipment usage, and
                safety compliance in real-time.
              </p>
        ...
        <TabsContent value="monitoring" className="mt-2">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Get instant insights into your construction site's performance
                with real-time monitoring tools. Track progress, identify
        ...
        <TabsContent value="reports" className="mt-2">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Generate comprehensive reports with a single click. Our
                automated reporting system compiles data from all site
                activities and presents it in easy-to-understand formats.
              </p>
