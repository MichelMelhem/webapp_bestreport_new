...
const PricingSection = () => {
  ...
  return (
    <section
      id="pricing"
      className="py-24 md:py-32 px-4 md:px-8 bg-[#0A0B0D] relative"
    >
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Select the appropriate tier for your construction monitoring needs.
            All plans include our core reporting infrastructure.
          </motion.p>
        </div>
                ...
                >
                  ...
                  >
                    <div className="p-8 bg-[#0F0F0F]">
                      ...
                      <p className="text-sm mb-6 text-gray-400 h-12">
                        {plan.description}
                      </p>
                      ...
                      <button
                        className={`w - full py - 3 px - 4 font - medium transition - all duration - 300 ${plan.popular
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-gray-400 mb-0">
                Our enterprise team can create a custom package for your
