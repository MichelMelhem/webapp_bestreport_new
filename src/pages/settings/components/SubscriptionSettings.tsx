    ...
    <div className="space-y-6">
      ...
      <Card className="border border-gray-200">
        <CardHeader className="pb-2">
          ...
          <CardDescription>Choose a subscription plan to access premium features.</CardDescription>
        </CardHeader>
        <CardContent className="pt-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <Card className="border border-gray-200 relative">
              ...
              <CardFooter>
                <Button variant="outline" className="w-full border border-gray-300 rounded-md h-10">
                  Choose Pro
                </Button>
              </CardFooter>
            </Card>
